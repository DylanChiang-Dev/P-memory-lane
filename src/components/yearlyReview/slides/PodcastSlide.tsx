            ...
            <div className="relative z-10 flex flex-col h-full p-5 pt-10 pb-safe">
                ...
                >
                    ...
                    <div className="text-right">
                        <span className="text-3xl font-black text-yellow-400">{data.total}</span>
                        <span className="text-sm text-yellow-400/60 ml-1">档</span>
                    </div>
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 0.4 }} className="mt-4 text-center">
                    <p className="text-sm text-white/40 italic">"在声音中寻找共鸣"</p>
                </motion.div>
            </div>
        </div>
    );
