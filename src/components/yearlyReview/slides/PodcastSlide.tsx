...
export const PodcastSlide: React.FC<PodcastSlideProps> = ({ data }) => {
    ...
    return (
        <div ref={containerRef} className="w-full h-full relative snap-start flex flex-col overflow-hidden bg-slate-950 text-white pb-safe">
            ...
            <div className="relative z-10 flex flex-col h-full p-6 pt-10 pb-safe">
                ...
                >
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h2 className="text-xl font-bold">播客</h2>
                            <p className="text-white/40 text-xs uppercase tracking-wider">Audio Stories</p>
                        </div>
                    </div>
                </motion.div>
                ...
                <div className="flex-1 flex flex-col space-y-6 overflow-hidden">
                    ...
                    >
                        <h3 className="text-base text-white/60 mb-1">听见世界的声音</h3>
                        <div className="flex items-baseline space-x-2">
                            <span className="text-5xl font-black text-yellow-400">{data.total}</span>
                            <span className="text-lg font-medium text-yellow-400/60">个频道</span>
                        </div>
                    </motion.div>
                        ...
                        {topItems.map((item, i) => (
                            ...
                            >
                                <div className="aspect-[2/3] bg-slate-800 rounded-lg overflow-hidden shadow-lg border border-white/5 relative">
                                    ...
                                    {item.my_rating && (
                                        <div className="absolute top-1 right-1 bg-black/60 px-1.5 py-0.5 rounded text-[10px] text-yellow-500 font-bold z-10 flex items-center">
                    ...
                    {remainingItems.length > 0 && (
                        <div className="relative mt-auto">
                            <h4 className="text-[10px] uppercase tracking-widest text-white/30 mb-2">还听了</h4>
            ...
            <ShareButton targetRef={containerRef} fileName="podcast-stats" />
        </div>
    );
};
