        ...
        <div className="w-full h-full relative snap-start flex flex-col overflow-hidden bg-slate-950 text-white">
            ...
            <div className="relative z-10 flex flex-col h-full p-8 pt-16">
                ...
                >
                    ...
                    <div>
                        <h2 className="text-2xl font-bold">游戏</h2>
                        <p className="text-white/40 text-sm">Virtual Worlds</p>
                    </div>
                </motion.div>
                ...
                <div className="flex-1 flex flex-col space-y-8">
                    ...
                    >
                        <h3 className="text-lg text-white/60 mb-2">探索无限可能</h3>
                        <div className="flex items-baseline space-x-2">
                            <span className="text-6xl font-black text-emerald-400">
                                {data.total}
                            </span>
                            <span className="text-xl font-medium text-emerald-400/60">款游戏</span>
                        </div>
                        <p className="text-white/40 text-sm mt-2">在 {data.total} 个虚拟世界中留下足迹</p>
                    </motion.div>
