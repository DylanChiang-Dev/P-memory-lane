        ...
        <div ref={containerRef} className="w-full h-full relative snap-start flex flex-col overflow-hidden bg-slate-950 text-white pb-safe">
            ...
            <div className="relative z-10 flex flex-col h-full p-6 pt-10 pb-safe">
                ...
                >
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-white/40 text-xs uppercase tracking-wider">Leveling Up</p>
                        </div>
                    </div>
                </motion.div>
                ...
                <div className="flex-1 flex flex-col space-y-6 overflow-hidden">
                    ...
                    >
                        <h3 className="text-base text-white/60 mb-1">在虚拟世界里畅游</h3>
                        <div className="flex items-baseline space-x-2">
                            <span className="text-5xl font-black text-emerald-400">{data.total}</span>
                            <span className="text-lg font-medium text-emerald-400/60">款游戏</span>
                        </div>
                    </motion.div>
                    ...
                    {remainingItems.length > 0 && (
                        <div className="relative mt-auto">
                            <h4 className="text-[10px] uppercase tracking-widest text-white/30 mb-2">还玩了</h4>
            ...
            <ShareButton targetRef={containerRef} fileName="games-stats" />
        </div>
    );
};
