        ...
        <div ref={containerRef} className="w-full h-full relative snap-start flex flex-col overflow-hidden bg-slate-950 text-white pb-safe">
            ...
            <div className="relative z-10 flex flex-col h-full p-6 pt-10 pb-safe">
                ...
                >
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-white/40 text-xs uppercase tracking-wider">Anime World</p>
                        </div>
                    </div>
                </motion.div>
                ...
                <div className="flex-1 flex flex-col space-y-6 overflow-hidden">
                    ...
                    >
                        <h3 className="text-base text-white/60 mb-1">打破二次元的壁垒</h3>
                        <div className="flex items-baseline space-x-2">
                            <span className="text-5xl font-black text-indigo-400">{data.total}</span>
                            <span className="text-lg font-medium text-indigo-400/60">部番剧</span>
                        </div>
                    </motion.div>
            ...
            <ShareButton targetRef={containerRef} fileName="anime-stats" />
        </div>
    );
};
